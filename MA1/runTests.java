...
class runTests{
    ...
    public static void main(String[] args) {
        //Test for problem 1
        // String[] arg = {"-R", "4", "-d", "data.txt", "wikipedia.txt","World Association of Theoretical and Computational Chemists"}
        // Search.main(arg);

        //Test for problem 2
        writeData("Problem 2");
        for(int i = 5; i <= 30; i+=5){
            String[] arg = {"-R", "4", "-W", "6", "-d", "tempData.txt", "wikipedia.txt", "World Association of Theoretical and Computational Chemists", Integer.toString(i)};
            Search.main(arg);
        }
        ...
        for(int i = 1; i <= 20; i++){
            String[] arg = {"-R", "4", "-W", "6", "-d", "tempData.txt", "-Ec", "wikipedia.txt", "World Association of Theoretical and Computational Chemists", Integer.toString(i)};
            Search.main(arg);
        }
